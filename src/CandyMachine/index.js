...
const CandyMachine = ({ walletAddress }) => {
  ...
  const mintToken = async () => {
    try {
      setIsMinting(true); //turn on loading effect
  ...
  const getCandyMachineState = async () => { 
    ...
    setIsLoadingMints(true); // Set loading flag
    ...
    setIsLoadingMints(false);  // Remove loading flag.
  ...
  const renderMintedItems = () => (
    <div className="gif-container">
      <p className="sub-text">Minted Malkmans ✨</p>
